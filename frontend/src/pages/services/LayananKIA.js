...
import { FaBabyCarriage, FaCheckCircle, FaArrowLeft, FaClock, FaPhone } from 'react-icons/fa';
...
const LayananKIA = () => {
    ...
    const layanan = [
        ...
        'Pemeriksaan USG 2 Dimensi',
        'Pemeriksaan dan Penyuluhan IVA dan SADARI',
        'Pelayanan KB',
        'Konseling KB',
        'Pelayanan Rujukan',
        'Pelayanan Efek Samping KB dan Komplikasi KB',
    ];
    ...
    return (
        <div className="service-detail-page">
            <style>{`
                ...
                .about-card, .services-card, .schedule-card, .contact-card {
                    opacity: 0;
                }
            ...
            <div 
                ...
                style={{ background: 'linear-gradient(135deg, #dc3545 0%, #b02a37 100%)', padding: '60px 0 40px' }}
            >
                <Container>
                    ...
                    <div className="d-flex align-items-center gap-3 mb-3">
                        <div className={`hero-icon ${isHeroVisible ? 'animate-fade-in-left' : ''}`} style={{ animationDelay: '0.1s' }}>
                            <div style={{ background: 'rgba(255,255,255,0.2)', borderRadius: '16px', width: 64, height: 64, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                <FaBabyCarriage size={28} color="white" />
                            </div>
                        </div>
                        <div>
                    ...
                    >
                        Kesehatan Ibu dan Anak — pelayanan komprehensif untuk mendukung kesehatan ibu hamil, bayi, dan balita.
                    </p>
                </Container>
            </div>
                    ...
                    <Row className="g-4">
                        <Col lg={8}>
                            <div className={`about-card ${isContentVisible ? 'animate-fade-in-up' : ''}`} style={{ animationDelay: '0.1s' }}>
                                <Card className="border-0 shadow-sm rounded-4 mb-4 hover-card">
                                    <Card.Body className="p-4">
                                        <h5 className="fw-bold mb-3" style={{ color: '#dc3545' }}>Tentang Layanan KIA</h5>
                                        <p style={{ color: '#4a5568', lineHeight: 1.8, marginBottom: 0 }}>
                                            Layanan KIA (Kesehatan Ibu dan Anak) merupakan salah satu pelayanan unggulan di Unit Kesehatan IPB University. Layanan ini memberikan pelayanan terpadu kepada Ibu dan Anak, mulai dari pemeriksaan kehamilan hingga konseling KB, dengan tenaga kesehatan yang terlatih dan berpengalaman di bidangnya.
                                        </p>
                                    </Card.Body>
                                </Card>
                            </div>
                            ...
                            <div className={`services-card ${isContentVisible ? 'animate-fade-in-up' : ''}`} style={{ animationDelay: '0.2s' }}>
                                <Card className="border-0 shadow-sm rounded-4 hover-card">
                                    <Card.Body className="p-4">
                                        <h5 className="fw-bold mb-4" style={{ color: '#dc3545' }}>Layanan yang Tersedia</h5>
                                        <div className="d-flex flex-column gap-2">
                                            {layanan.map((item, i) => (
                                                <div 
                                                    key={i} 
                                                    className={`service-item d-flex align-items-start gap-2 p-3 ${isContentVisible ? 'animate-fade-in-up' : ''}`}
                                                    style={{ 
                                                        background: '#fff5f5', 
                                                        borderRadius: 10,
                                                ...
                                                >
                                                    <FaCheckCircle color="#dc3545" size={16} style={{ marginTop: 2, flexShrink: 0 }} />
                        ...
                        <Col lg={4}>
                                ...
                                <Card className="border-0 shadow-sm rounded-4 mb-4 hover-card">
                                    <Card.Body className="p-4">
                                        <h6 className="fw-bold mb-3">
                                            <FaClock className="me-2 text-danger" /> Jam Operasional
                                        </h6>
                            ...
                            <div className={`contact-card ${isContentVisible ? 'animate-fade-in-right' : ''}`} style={{ animationDelay: '0.2s' }}>
                                <Card className="border-0 shadow-sm rounded-4 hover-card" style={{ background: '#dc3545' }}>
                                    <Card.Body className="p-4">
